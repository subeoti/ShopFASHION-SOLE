...
namespace AppData.Configurations
{
    internal class NhanVienConfiguration : IEntityTypeConfiguration<NhanVien>
    {
        public void Configure(EntityTypeBuilder<NhanVien> builder)
        {
            ...
            builder.HasData(new NhanVien() { ID = new Guid("2EC27AB7-5F67-4ED5-AE67-52F9C9726EBF"), Ten = "Admin", Email = "admin@gmail.com", SDT = "0985143915", DiaChi = "Ha Noi", TrangThai = 1, IDVaiTro = new Guid("B4996B2D-A343-434B-BFE9-09F8EFBB3852"), PassWord = "$2a$10$VgW0LFrnJ4GQy/LncbfGCeDa8TuErN0Jxx/tFWuKCNOUwwyOzyfDK" });
        }
    }
}
