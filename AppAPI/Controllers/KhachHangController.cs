...
namespace AppAPI.Controllers
{
    ...
    public class KhachHangController : ControllerBase
    {
        ...
        public static bool CanEdit(string ID)
        {
            if (ID == "2EC27AB7-5F67-4ED5-AE67-52F9C9726EBF")
            {
                return true; // Admin có quyền "Sửa"
            }
            else
            {
                return false; // Người dùng khác không có quyền "Sửa"
            }
        }
    }
}
